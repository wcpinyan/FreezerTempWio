...
#define AIO_USERNAME    "wcpinyan"
#define AIO_KEY         "a70f57564a7c2c56344ef25d30069345dea33605"
const char* ssid = "Linksys01"; //Wi-Fi name    "2nd_Floor"
const char* password =  "dianne"; //Wi-Fi password    "Lakpass321."
...
Adafruit_MQTT_Publish temperature = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/FreezerTemp");
